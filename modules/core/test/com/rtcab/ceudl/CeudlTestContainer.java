...
public class CeudlTestContainer extends TestContainer {

    public CeudlTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/ceudl/app.properties",
    ...
    public static class Common extends CeudlTestContainer {

        public static final CeudlTestContainer.Common INSTANCE = new CeudlTestContainer.Common();
